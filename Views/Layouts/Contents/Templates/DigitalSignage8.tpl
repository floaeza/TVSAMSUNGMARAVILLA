...
<script>
    ...
    var Videosrc = 'http://10.0.3.241/Demos/Media/Claseazul9OCT_ing.mp4';

    var imgArray = [
            'http://10.0.3.241/Demos/Media/1.png',
            'http://10.0.3.241/Demos/Media/2.jpg',
            'http://10.0.3.241/Demos/Media/3.png',
            'http://10.0.3.241/Demos/Media/4.jpg'
        ],
        curIndex = 0;
    imgDuration = 5000;
    ...
    var imgArray2 = [
            'http://10.0.3.241/Demos/Media/dining.png',
            'http://10.0.3.241/Demos/Media/dining1.jpg',
            'http://10.0.3.241/Demos/Media/activi.png',
            'http://10.0.3.241/Demos/Media/activi1.jpg'
        ],
        curIndex2 = 0;
    imgDuration2 = 6000;
