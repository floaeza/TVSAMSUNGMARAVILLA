...
Devices = requests.post('http://172.22.22.10BBINCO/TV/Core/Controllers/DevicesStatus.php', data=payload)
...
for ips in IDF:
    ...
    try:
        ...
        req = requests.post('http://172.22.22.10BBINCO/TV/Core/Controllers/DevicesStatus.php', data=info)            
    except:
