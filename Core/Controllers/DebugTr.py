...
pak = requests.post('http://172.22.22.10/BBINCO/TVS/Core/Controllers/PY.php', data=payload)
...
for pos in range(len(listDays)):
    ...
    req = requests.post('http://172.22.22.10/BBINCO/TVS/Core/Controllers/Packages.php', data=info)
