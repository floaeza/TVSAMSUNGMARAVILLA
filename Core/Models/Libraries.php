...
if($GetJson == true){
    ...
    $JsonLibraries['EpgLogo'] = '/BBINCO/TVSMARAVILLA/Media/Logos/'.$Client.$EpgLogo;
}
...
$JsonLibraries['ServerSource']      = 'http://'.$ServerIp.'/BBINCO/TVSMARAVILLA/';
...
$ServerSource = 'http://'.$ServerIp.'/BBINCO/TVSMARAVILLA/';
